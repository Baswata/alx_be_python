...
match priority:
    case "high":
        if time_bound == "yes":
            ...
            print(f"Reminder: '{task}' is a high priority task. Schedule it early in your day.")
    ...
    case "low":
        if time_bound == "yes":
            print(f"Note: '{task}' is a low priority but time-sensitive task. Don't let it slip!")
        else:
